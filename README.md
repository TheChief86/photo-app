...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create photo-app-8011
  fly apps create photo-app-8011-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app photo-app-8011
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app photo-app-8011-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'photo-app-8011-staging' does not match app name in config file 'photo-app-8011'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name photo-app-8011-db
  fly postgres attach --app photo-app-8011 photo-app-8011-db

  fly postgres create --name photo-app-8011-staging-db
  fly postgres attach --app photo-app-8011-staging photo-app-8011-staging-db
  ```
